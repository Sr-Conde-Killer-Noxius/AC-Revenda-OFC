import { Home, Package, Settings, LogOut, UsersRound, MessageSquare, Webhook, MessageCircle, Link2, Wallet, Shield, User, HelpCircle, CreditCard } from "lucide-react";
...
const allMenuItems = [
  ...
  { title: "Mercado Pago", url: "/settings/mercado-pago", icon: CreditCard },
